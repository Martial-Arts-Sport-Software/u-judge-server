...
object Localization {
    private val strings = mapOf(
        "en" to mapOf(
            ...
            "devices_addresses_title" to "Server addresses",
            "devices_addresses_hint" to "A judge can use any of them if the main address is not reachable from the phone network.",
            "devices_addresses_main" to "main",
            "devices_copy" to "Copy",
            "devices_copied" to "Copied",
        ...
        "ru" to mapOf(
            ...
            "devices_addresses_title" to "Адреса сервера",
            "devices_addresses_hint" to "Судья может ввести любой из них, если основной адрес недоступен из сети телефона.",
            "devices_addresses_main" to "основной",
            "devices_copy" to "Копировать",
            "devices_copied" to "Скопировано",
