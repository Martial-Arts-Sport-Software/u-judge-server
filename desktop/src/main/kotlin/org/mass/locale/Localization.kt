...
object Localization {
    private val strings = mapOf(
        "en" to mapOf(
            ...
            "devices_server_address" to "Server IP address: %s",
            "devices_server_address_other" to "Also: %s",
            "devices_server_address_unknown" to "No network found, port %s",
            "devices_code" to "Server code: %s",
            "devices_code_hint" to "Approve a judge only if the phone shows the same code.",
            "devices_server_running" to "Server is running; events are stored in the local database",
            "devices_server_failed" to "Server or database failure, see the message above",
        ...
        "ru" to mapOf(
            ...
            "devices_server_address" to "IP адрес сервера: %s",
            "devices_server_address_other" to "Также: %s",
            "devices_server_address_unknown" to "Сеть не найдена, порт %s",
            "devices_code" to "Код сервера: %s",
            "devices_code_hint" to "Подтверждайте судью, только если на телефоне тот же код.",
            "devices_server_running" to "Сервер работает, события сохраняются в локальной базе",
            "devices_server_failed" to "Сбой сервера или базы данных, см. сообщение выше",
